...
var StorageClasses = []string{
	...
	standardUID("1.2.840.10008.5.1.4.1.1.2.2"),
	...
	standardUID("1.2.840.10008.5.1.4.1.1.4.4"),
	...
	standardUID("1.2.840.10008.5.1.4.1.1.13.1.4"),
	standardUID("1.2.840.10008.5.1.4.1.1.13.1.5"),
	standardUID("1.2.840.10008.5.1.4.1.1.14.1"),
	standardUID("1.2.840.10008.5.1.4.1.1.14.2"),
	standardUID("1.2.840.10008.5.1.4.1.1.20"),
	standardUID("1.2.840.10008.5.1.4.1.1.30"),
	...
	standardUID("1.2.840.10008.5.1.4.1.1.77.1.5.5"),
	standardUID("1.2.840.10008.5.1.4.1.1.77.1.5.6"),
	...
	standardUID("1.2.840.10008.5.1.4.1.1.82.1"),
	...
	standardUID("1.2.840.10008.5.1.4.1.1.88.35"),
	...
	standardUID("1.2.840.10008.5.1.4.1.1.88.68"),
	...
	standardUID("1.2.840.10008.5.1.4.1.1.128.1"),
